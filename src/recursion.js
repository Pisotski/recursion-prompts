...
var arraySum = function(array) {
  ...
  return array.reduce((memo, el) => {
    return memo + (Array.isArray(el) ? arraySum(el) : Number(el))
  },0);
};
...
var countKeysInObj = function(obj, key) {
  ...
  for ( var k in obj ) {
    ...
    if ( typeof obj[k] === 'object') {
      times += countKeysInObj(obj[k], key);
    }
  }
  return times;
};
...
var countValuesInObj = function(obj, value) {
  ...
  for ( var k in obj ) {
    ...
    if ( typeof obj[k] === 'object') {
      times += countValuesInObj(obj[k], value);
    }
  }
...
var capitalizeWords = function(array) {
  ...
  var it = array.pop().toUpperCase();
  return capitalizeWords(array).concat([it]);
};
...
var capitalizeFirst = function(array) {
  ...
  return capitalizeFirst(array).concat([it]);
};
...
var compress = function(list) {
  ...
  var curr = list[0];
  return curr === list[1] ? compress(list.slice(1)) : [curr].concat(compress(list.slice(1)));
};
...
var augmentElements = function(array, aug) {
  ...
  var el = array.shift();
  el.push(aug);
  return [el].concat(augmentElements(array, aug));
};
...
var minimizeZeroes = function(array) {
  ...
  return add.concat(minimizeZeroes(array.slice(1)))
};
...
var alternateSign = function(array) {
  ...
  var el = array.length % 2 === 0 ? -Math.abs(array.pop()) : Math.abs(array.pop());
  return alternateSign(array).concat([el]);
};
...
var numToText = function(str) {
  ...
  var chunk = splitted.shift();
  var newString = splitted.join(' ');
  chunk = nums[chunk] || chunk;
  if ( newString.length ) {
    chunk += ' ';
  }

  return chunk + numToText(newString);
};
